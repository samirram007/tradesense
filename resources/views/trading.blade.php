...
<div class="container-fluid trading">
    <div class="row">
        <div class="col col-12 col-md-4 trading-one border-bottom border-info">
            ...
            <p class="mt-4 text-white">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Beatae molestiae
                consequuntur
                perspiciatis
        ...
        <div class="col col-12 col-md-4 trading-two pt-5 border-bottom border-info">
            ...
            <p class="pt-3 text-white">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Beatae molestiae
                consequuntur
                perspiciatis
                ea nisi nostrum officiis aut dolorem deleniti commodi culpa, assumenda vitae reiciendis eius odio quam
                qui corrupti ex?</p>
        ...
        <div class="col col-12 col-md-4 trading-three pt-5 border-bottom border-info ">
            ...
            <p class="pt-3 text-white fs-6">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Beatae molestiae
                consequuntur
                perspiciatis
                ea nisi nostrum officiis aut dolorem deleniti commodi culpa, assumenda vitae reiciendis eius odio quam
                qui corrupti ex?</p>
